...
const AgentSpawnRow = memo(function AgentSpawnRow(props: {
  ...
  // Providers may aggregate member usage into the coordinator, so count the
  // coordinator only when no members exist.
  ...
  return (
    <div className="flex flex-col">
      <button
        ...
        className="flex w-full cursor-pointer items-center gap-2 rounded-md border border-border/60 surface-glass px-2.5 py-1.5 text-left transition-colors hover:bg-accent/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring/70"
      >
