  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[--chat-composer-drawer-inset:1.375rem] [--chat-composer-glass-surface:var(--glass-surface)] [--chat-composer-outline:rgb(0_0_0/8%)]",
        "dark:[--chat-composer-highlight:rgb(255_255_255/3%)] dark:[--chat-composer-outline:color-mix(in_srgb,var(--color-white)_5%,transparent)]",
        "[html[data-theme-id]_&]:[--chat-composer-outline:var(--app-theme-toolbar-border)]",
